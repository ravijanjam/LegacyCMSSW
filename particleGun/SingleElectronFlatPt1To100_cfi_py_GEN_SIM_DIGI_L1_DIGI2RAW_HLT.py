...
# with command line options: Configuration/Generator/python/SingleElectronFlatPt1To100_cfi.py --conditions STARTHI53_V27::All --eventcontent RAWDEBUG -s GEN,SIM,DIGI,L1,DIGI2RAW,HLT:PIon --datatier GEN-SIM --beamspot Realistic8TeVCollisionPPbBoost -n 10 --no_exec
...
process.RAWDEBUGoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('SingleElectronFlatPt1To100_cfi_py_GEN_SIM_DIGI_L1_DIGI2RAW_HLT.root'),
