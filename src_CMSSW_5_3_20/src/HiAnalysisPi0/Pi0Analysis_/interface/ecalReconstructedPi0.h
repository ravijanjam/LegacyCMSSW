#ifndef PI0ECALRECONSTRUCTION_H
#define PI0ECALRECONSTRUCTION_H
...
class ecalReconstructedPi0 : public edm::EDAnalyzer {

public:

  explicit ecalReconstructedPi0( const edm::ParameterSet& );
  ~ecalReconstructedPi0();
